...
PROMPTSHIELD_TEST_EMBED = CACHE / "triage_promptshield_test_text_embedding_3_small.npy"

SUBSETS = {
    "balanced_2000": RESULTS / "triage_openai_promptshield_test_balanced2000.json",
    "natural_3000": RESULTS / "triage_openai_promptshield_test_natural3000.json",
}
...
def main() -> None:
    ...
    tfidf = joblib.load(MODELS / "triage_tfidf_logreg_promptshield.pkl")
    emb_lr = joblib.load(MODELS / "triage_openai_embedding_logreg.pkl")
    emb_rf = joblib.load(MODELS / "triage_openai_embedding_random_forest.pkl")

    results: dict[str, Any] = {
        "experiment": "triage_subset_classifier_comparison",
    ...
    out = RESULTS / "triage_subset_classifier_comparison.json"
