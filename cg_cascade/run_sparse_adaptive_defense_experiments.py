...
OUT_JSON = RESULTS / "triage_sparse_adaptive_defense_experiments.json"
OUT_MD = RESULTS / "triage_sparse_adaptive_defense_experiments.md"
...
def load_mixed_stream(
    ...
    *,
    ...
    e2e_by_id = {str(r["sample_id"]): r for r in json.loads((RESULTS / "triage_adaptive_padding_e2e.json").read_text())["records"]}
    judge_by_id = {str(r["sample_id"]): r for r in ps_records}
    judge_by_id.update(e2e_by_id)
    mix_cache = RESULTS / "triage_adaptive_mix1pct_judge_cache.json"
...
def main() -> None:
    ...
    payload = {
        "experiment": "triage_sparse_adaptive_defense_experiments",
        "mixture_rate": 0.01,
        "seed": SEED,
        "tau_safe": NP_CAL_TAU,
