#!/usr/bin/env python
"""OpenAI-embedding classifier baselines for the revised IWSEC study."""
...
from run_iwsec_classical_experiments import (
    DATA,
    MODELS,
    RESULTS,
    EXTERNAL_DATASETS,
...
EMBED = {
    "promptshield_train": CACHE / "iwsec_promptshield_train_text_embedding_3_small.npy",
    "promptshield_validation": CACHE / "iwsec_promptshield_validation_text_embedding_3_small.npy",
    "promptshield_test": CACHE / "iwsec_promptshield_test_text_embedding_3_small.npy",
    "deepset_semantic_all": CACHE / "iwsec_deepset_semantic_all_text_embedding_3_small.npy",
    "notinject_hard_negatives": CACHE / "iwsec_notinject_hard_negatives_text_embedding_3_small.npy",
    "lakera_gandalf_attack_only": CACHE / "iwsec_lakera_gandalf_attack_only_text_embedding_3_small.npy",
}
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, default=RESULTS / "iwsec_embedding_classifiers.json")
...
def main() -> None:
    ...
    for bundle in bundles:
        ...
        model_path = MODELS / f"iwsec_{bundle['name']}.pkl"
        joblib.dump(bundle, model_path)
        result["model_path"] = str(model_path)

    payload = {
        "experiment": "iwsec_embedding_classifiers",
