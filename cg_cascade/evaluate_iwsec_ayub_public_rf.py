#!/usr/bin/env python
"""Evaluate the public Ayub OpenAI-embedding RF on revised IWSEC datasets."""
...
from run_iwsec_embedding_experiments import EMBED, load_xy, positive_scores
...
def main() -> None:
    ...
    payload = {
        "experiment": "iwsec_ayub_public_rf_zero_shot",
    ...
    out = RESULTS / "iwsec_ayub_public_rf_zero_shot.json"
