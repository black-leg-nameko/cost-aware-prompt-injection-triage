#!/usr/bin/env python
"""Prepare semantically labeled prompt-injection datasets for IWSEC experiments."""
...
def prepare(seed: int, *, include_examples: bool) -> dict[str, Any]:
    ...
    payload = {
        "experiment": "iwsec_dataset_preparation",
        "seed": seed,
        "label_policy": {
    ...
    (RESULTS / "iwsec_dataset_audit.json").write_text(json.dumps(payload, ensure_ascii=False, indent=2), encoding="utf-8")
    return payload
