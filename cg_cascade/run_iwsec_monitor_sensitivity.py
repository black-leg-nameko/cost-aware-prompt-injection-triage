#!/usr/bin/env python
"""Sensitivity of shift-monitor thresholds on IWSEC streams, including sparse padded mixes."""
...
def main() -> None:
    ...
    payload = {
        "experiment": "iwsec_monitor_sensitivity",
        "includes_sparse_padded_mixtures": True,
        "psi_thresholds": psi_thresholds,
        "rows": rows,
    }
    out = RESULTS / "iwsec_monitor_sensitivity.json"
