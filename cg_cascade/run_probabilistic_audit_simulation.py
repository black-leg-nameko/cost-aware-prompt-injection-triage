...
INPUT = RESULTS / "triage_adaptive_padding_attack.json"
OUT_JSON = RESULTS / "triage_probabilistic_audit_simulation.json"
OUT_MD = RESULTS / "triage_probabilistic_audit_simulation.md"
...
def main() -> None:
    ...
    payload = {
        "experiment": "triage_probabilistic_bypass_audit_simulation",
        "source": str(INPUT),
        "scope": (
