#!/usr/bin/env python
"""Parallel OpenAI LLM-judge evaluation for revised IWSEC experiments."""
...
def save_checkpoint(
    ...
    *,
    ...
    payload = {
        "experiment": "iwsec_openai_llm_judge",
        "status": status,
        "model": args.model,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--router-model", type=Path, default=MODELS / "iwsec_tfidf_logreg_promptshield.pkl")
