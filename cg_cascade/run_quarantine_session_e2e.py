...
from run_adaptive_padding_e2e import collect_adaptive_prompts
from run_shift_failsafe_experiment import NP_CAL_TAU, RESULTS


OUT_JSON = RESULTS / "triage_quarantine_session_e2e.json"
OUT_MD = RESULTS / "triage_quarantine_session_e2e.md"
AUDIT_RATE = 0.05
AUDIT_SEED = 0
...
def load_attack_pool() -> list[dict[str, Any]]:
    ...
    e2e_path = RESULTS / "triage_adaptive_padding_e2e.json"
...
def main() -> None:
    ...
    payload = {
        "experiment": "triage_quarantine_session_e2e",
        "tau_safe": NP_CAL_TAU,
        "audit_rate": AUDIT_RATE,
