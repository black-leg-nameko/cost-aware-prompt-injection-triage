...
from run_iwsec_openai_judge import load_dotenv, openai_judge
from run_iwsec_shift_failsafe_experiment import REFERENCE, load_records
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=RESULTS / "iwsec_adaptive_padding_e2e.json")
    ...
    payload = {
        "experiment": "iwsec_adaptive_padding_e2e",
        "status": "completed",
        "model": args.model,
        "tau_safe": TAU,
        "seed": SEED,
