#!/usr/bin/env python
"""Classical detector baselines for the revised IWSEC prompt-injection study."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, default=RESULTS / "iwsec_classical_promptshield.json")
    parser.add_argument("--model-output", type=Path, default=MODELS / "iwsec_tfidf_logreg_promptshield.pkl")
...
def main() -> None:
    ...
    payload = {
        "experiment": "iwsec_classical_promptshield",
