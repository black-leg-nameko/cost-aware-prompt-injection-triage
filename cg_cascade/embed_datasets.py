#!/usr/bin/env python
"""Generate OpenAI embeddings for revised cost-aware triage datasets with chunk-level resume."""
...
def embed_dataset(name: str, path: Path, args: argparse.Namespace) -> dict[str, Any]:
    ...
    out_path = CACHE / f"triage_{name}_{args.embedding_model.replace('-', '_')}.npy"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, default=RESULTS / "triage_embedding_generation.json")
...
def main() -> None:
    ...
    payload = {
        "experiment": "triage_embedding_generation",
        "embedding_model": args.embedding_model,
