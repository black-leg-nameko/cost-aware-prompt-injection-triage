...
OUT_JSON = RESULTS / "triage_sparse_mix_audit_e2e.json"
OUT_MD = RESULTS / "triage_sparse_mix_audit_e2e.md"
MIX_RATE = 0.01
AUDIT_RATE = 0.05
AUDIT_SEED = 0
...
def main() -> None:
    ...
    e2e_cache = e2e_by_sample_id(RESULTS / "triage_adaptive_padding_e2e.json")
    ...
    payload = {
        "experiment": "triage_sparse_mix_audit_e2e",
        "scope": (
